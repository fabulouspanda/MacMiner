 ...
 * points in the lifetime of the task. Evolved from the taskThreeWrapper class
 ...
 *
 * taskThreeWrapper objects are one-shot, like NSTask. If you need to run
 * a task more than once, create new taskThreeWrapper instances.
 */
@interface taskThreeWrapper : NSObject
{
	id <taskThreeWrapperDelegate>_taskDelegate;
