...
@synthesize activity, allowMobileMinerControl, asicAPIStorage, asicAPIStorage2, asicReadBack, asicReading, bfgReadBack, bfgReading, bfgSettingString, bfgSettingText, cgReadBack, cgReading, cpuReadBack, cpuReading, disableHttpsButton, dockView, foundData, hideVersionStuff, mobileMinerArrayController, mobileMinerDataArray, mobileMinerStatus, releaseNotes;
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    if ([prefs objectForKey:@"checkUpdates"]) {
        ...
        NSString *stringVersion = [NSString stringWithContentsOfURL:[NSURL URLWithString:@"http://downloads.fabulouspanda.co.uk/snowversion.html"]encoding:NSUTF8StringEncoding error:nil];
