...
NSImageView *asicReadBack;
NSTextField *asicReading;
    
NSString *bfgSettingString;
NSTextField *bfgSettingText;
    
NSMutableArray *mobileMinerDataArray;
NSArrayController *mobileMinerArrayController;
    
NSTextView *asicAPIStorage;
NSTextView *asicAPIStorage2;
    
NSButton *disableHttpsButton;
    
NSButton *allowMobileMinerControl;
    
NSButton *hideVersionStuff;
    
NSWindow *releaseNotes;
